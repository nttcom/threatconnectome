    ...
    },
    {
        ...
        "threatconnectome": {
            ...
            "description": (
                ...
                "application-deployment tool enabling infrastructure as code. ansible extends the "
                "basic ansible-core with additional modules by delivering several collections in an "
                "easy-to-consume PyPI package. The ansible community package typically gets 2 major "
                "releases every year. A new minor version is released every 4 weeks. Maintenance "
                "fixes are guaranteed for only the latest major release.\nSee the Ansible Roadmap "
