...
export const getSsvcPriorityProps = () => {
  const prop_immediate = {
    displayName: t("ssvcUtils.priority.immediate.displayName", { ns: "utils" }),
    icon: RunningWithErrorsIcon,
    statusLabel: t("ssvcUtils.priority.immediate.statusLabel", { ns: "utils" }),
    style: {
      bgcolor: red[600],
      color: "white",
      textTransform: "none",
  ...
  const prop_out_of_cycle = {
    displayName: t("ssvcUtils.priority.out_of_cycle.displayName", { ns: "utils" }),
    icon: WarningIcon,
    statusLabel: t("ssvcUtils.priority.out_of_cycle.statusLabel", { ns: "utils" }),
    style: {
      bgcolor: orange[600],
      color: "white",
      textTransform: "none",
  ...
  const prop_scheduled = {
    displayName: t("ssvcUtils.priority.scheduled.displayName", { ns: "utils" }),
    icon: PriorityHighIcon,
    statusLabel: t("ssvcUtils.priority.scheduled.statusLabel", { ns: "utils" }),
    style: {
      bgcolor: amber[600],
      color: "white",
      textTransform: "none",
  ...
  const prop_defer = {
    displayName: t("ssvcUtils.priority.defer.displayName", { ns: "utils" }),
    icon: CheckIcon,
    statusLabel: t("ssvcUtils.priority.defer.statusLabel", { ns: "utils" }),
    style: {
      bgcolor: grey[600],
      color: "white",
      textTransform: "none",
