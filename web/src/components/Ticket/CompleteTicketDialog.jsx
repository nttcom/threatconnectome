...
export function CompleteTicketDialog(props) {
  ...
  // Get user info
  const { data: userMe, error: userMeError, isLoading: isLoadingUserMe } = useGetUserMeQuery();

  // Get vulnerability info
  const { data: vuln, error: vulnError, isLoading: isLoadingVuln } = useGetVuln(vulnId);
