...
} from "./sbomManagementPrototypeUtils";
...
export function SBOMManagementPrototype({ initialActiveId, initialSboms = createDefaultSboms() }) {
...
export default SBOMManagementPrototype;
