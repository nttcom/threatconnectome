...
import type { MenuToggleHandler, TopbarLabels, TopbarPageItem } from "./topbarTypes";
...
export function PageMenuButton({ active, currentPage, labels, onClick }: PageMenuButtonProps) {
