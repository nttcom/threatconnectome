          ...
          if (vulnId === "vuln-001") {
            return HttpResponse.json([
              ...
              },
              {
                ...
                ticket_safety_impact_change_reason: "Scheduled for next sprint",
                ticket_status: {
                  status_id: "status-003",
                  ticket_handling_status: "scheduled",
                  user_id: "user-001",
                  created_at: "2025-11-25T10:00:00.032Z",
                  updated_at: "2025-11-25T14:00:00.032Z",
                  assignees: ["user-001", "user-002"],
                  note: "Scheduled for 2025-12-01 - 対応中",
              ...
              },
              {
                ...
                ticket_safety_impact_change_reason: "Fixed in latest version",
                ticket_status: {
                  status_id: "status-004",
                  ticket_handling_status: "completed",
                  user_id: "user-002",
                  created_at: "2025-11-20T10:00:00.032Z",
      ...
      handlers: [
        ...
        http.get(`*/pteams/${pteamId}/tickets`, ({ request }) => {
          ...
          const tickets = Array.from({ length: numTickets }, (_, i) => ({
            ...
            vuln_id: vulnId,
            dependency_id: i % 2 === 0 ? "dep-001" : "dep-002",
            service_id: serviceId,
            pteam_id: pteamId,
