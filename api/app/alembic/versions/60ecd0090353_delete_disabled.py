...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'actionlog', 'pteam', ['pteam_id'], ['pteam_id'], ondelete='CASCADE')
    op.drop_constraint('ateampteam_pteam_id_fkey', 'ateampteam', type_='foreignkey')
    op.create_foreign_key(None, 'ateampteam', 'pteam', ['pteam_id'], ['pteam_id'], ondelete='CASCADE')
    op.drop_constraint('currentpteamtopictagstatus_pteam_id_fkey', 'currentpteamtopictagstatus', type_='foreignkey')
    op.create_foreign_key(None, 'currentpteamtopictagstatus', 'pteam', ['pteam_id'], ['pteam_id'], ondelete='CASCADE')
    op.drop_constraint('pteamaccount_pteam_id_fkey', 'pteamaccount', type_='foreignkey')
    op.create_foreign_key(None, 'pteamaccount', 'pteam', ['pteam_id'], ['pteam_id'], ondelete='CASCADE')
    op.drop_constraint('pteamauthority_pteam_id_fkey', 'pteamauthority', type_='foreignkey')
    op.create_foreign_key(None, 'pteamauthority', 'pteam', ['pteam_id'], ['pteam_id'], ondelete='CASCADE')
    op.drop_constraint('pteaminvitation_pteam_id_fkey', 'pteaminvitation', type_='foreignkey')
    op.create_foreign_key(None, 'pteaminvitation', 'pteam', ['pteam_id'], ['pteam_id'], ondelete='CASCADE')
    op.drop_constraint('pteamtopictagstatus_pteam_id_fkey', 'pteamtopictagstatus', type_='foreignkey')
    op.create_foreign_key(None, 'pteamtopictagstatus', 'pteam', ['pteam_id'], ['pteam_id'], ondelete='CASCADE')
