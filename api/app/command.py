...
def count_service_tickets_per_threat_impact(
    ...
    for dependency in service.dependencies:
        ...
        for threat in dependency.threats:
            ...
            if not is_solved and not threat.ticket.curent_ticket_status:
            ...
            for _curent_ticket in threat.ticket.curent_ticket_status:
                if is_solved and _curent_ticket.topic_status == _completed:
                    if 1 == _curent_ticket.threat_impact:
                        threat_counts_rows["1"] += 1
                    elif 2 == _curent_ticket.threat_impact:
                        threat_counts_rows["2"] += 1
                    elif 3 == _curent_ticket.threat_impact:
                        threat_counts_rows["3"] += 1
                    elif 4 == _curent_ticket.threat_impact:
                        threat_counts_rows["4"] += 1
...
def get_sorted_ticket_ids_by_service_tag_and_status(
    service: models.Service,
    tag_id: UUID | str,
    is_solved: bool,
) -> Sequence[str]:
