...
def fix_current_status_by_pteam(db: Session, pteam: models.PTeam):
    ...
    insert_stmt = psql_insert(models.CurrentPTeamTopicTagStatus).from_select(
        ["pteamId", "topicId", "tagId", "statusId", "topicStatus", "threatImpact", "updatedAt"],
        new_currents,
    )
    db.execute(
        insert_stmt.on_conflict_do_update(
            index_elements=["pteamId", "topicId", "tagId"],
            set_={
                "statusId": insert_stmt.excluded.statusId,
                "threatImpact": insert_stmt.excluded.threatImpact,
                "updatedAt": insert_stmt.excluded.updatedAt,
            },
        )
    )
