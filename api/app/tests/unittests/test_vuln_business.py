...
from app.business import vuln_business
...
class TestCalculateContentFingerprint:
    def test_equals_fingerprints_when_affect_order_is_different(self):
        ...
        # Then
        assert vuln_business.calculate_content_fingerprint_by_vuln(
            vuln1
        ) == vuln_business.calculate_content_fingerprint_by_vuln(vuln2)
